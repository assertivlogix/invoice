...
<div class="row justify-content-center">
    <div class="col-12 col-md-8 col-lg-6">
        <div class="checkout-card">
            <!-- Brand Header -->
            <div class="brand-header text-center" style="background: linear-gradient(135deg, #072654 0%, #0c4a6e 100%);">
                <h4 class="fw-bold mb-1 text-white"><i class="fa-solid fa-file-invoice-dollar me-2"></i> {{ $company->company_name }}</h4>
            ...
            <div class="p-4">
                ...
                <div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
                    <div>
                        ...
                        <small class="text-muted">Issued: {{ $invoice->invoice_date->format('M d, Y') }} &bull; Due: {{ $invoice->due_date->format('M d, Y') }}</small>
                    </div>
                    <div class="text-end">
                        <span class="badge bg-warning-subtle text-warning border border-warning px-3 py-2 fs-13">Payment Required</span>
                    </div>
                </div>
                ...
                <div class="bg-light p-3 rounded-3 mb-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="fw-bold fs-22 text-primary">{{ $invoice->currency_symbol }}{{ number_format($invoice->balance_due, 2) }}</span>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="border border-2 border-primary p-3 rounded-3 bg-white d-flex align-items-center justify-content-between shadow-sm">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Instant Payment via UPI (GPay, PhonePe, Paytm), NetBanking & Cards</small>
                            </div>
                        </div>
                ...
                <form action="{{ route('public.payment.process', $link->token) }}" method="POST" id="razorpayForm">
                    ...
                    <button type="button" id="payRazorpayBtn" class="btn btn-primary btn-lg w-100 py-3 fw-bold rounded-3 shadow">
                        <i class="fa-solid fa-lock me-2"></i> Pay {{ $invoice->currency_symbol }}{{ number_format($invoice->balance_due, 2) }} via Razorpay
                    </button>
                </form>
            </div>
        </div>
